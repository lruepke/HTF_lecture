...
BLOCKED VECTORIZED PROCESSING - optimal for large meshes.
Processes elements in blocks for better cache utilization while
maintaining full NumPy vectorization within each block.
"""
